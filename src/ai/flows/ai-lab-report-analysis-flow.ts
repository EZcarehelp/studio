...
3.  **Actionable Suggestions:** Based on the report, offer 2-4 actionable health or lifestyle suggestions (e.g., "Increase intake of iron-rich foods like spinach and lentils," "Consider a 20-minute brisk walk daily," "Ensure adequate hydration by drinking 8 glasses of water."). These should be general wellness tips.
...
-   Ensure all output fields in the JSON schema are populated appropriately. If a section (like warnings) is not applicable, you can provide a statement like "No specific warnings based on this report alone, but always consult your doctor for concerns." or an empty array if the schema allows.
...
`,
  config: {
    temperature: 0.3, // Lower temperature for more factual and less creative interpretation
    safetySettings: [
      { category: 'HARM_CATEGORY_DANGEROUS_CONTENT', threshold: 'BLOCK_MEDIUM_AND_ABOVE' },
      { category: 'HARM_CATEGORY_MEDICAL', threshold: 'BLOCK_MEDIUM_AND_ABOVE' }, // Adjust if too restrictive for report interpretation
